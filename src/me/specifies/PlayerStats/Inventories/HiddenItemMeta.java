...
/*
 * Class that contains functions that take a json string, encodes it, then hides it in an item lore for later manipulation.
 * All credits go to https://gist.github.com/filoghost/f53ecb7b014c40b66bdc
 */
